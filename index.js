 ...
 * @param  {String} [args.id]     The default API client ID
 ...
 */
const initialize = function initialize ({ origin, locale, id, secret, token }, axios = {}) {
  return new Blizzard({ origin, locale, id, secret, token }, axios);
};
