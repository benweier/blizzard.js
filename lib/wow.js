...
WoW.prototype.battlepet = function battlepet (key, args, instance) {
  ...
  const fields = this.blizzard.params(['level', 'breedId', 'qualityId'], args.fields);
  const params = { fields: fields.toString() };

  return this.blizzard.get(path, args, Object.assign({}, instance, { params }));
};
...
WoW.prototype.realm = function realm (args, instance) {
  ...
  return this.blizzard.get(path, args, Object.assign({}, instance, { params: realms }));
};
...
WoW.prototype.zone = function zone (args, instance) {
  return this.blizzard.get(`/wow/zone/${args.id}`, args, instance);
};
