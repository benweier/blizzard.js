 ...
 * @return {Promise}              A thenable Promises/A+ reference
 */
WoW.prototype.character = function character (args) {
  const path = `/wow/character/${args.realm}/${args.name}`;
  const fields = this.params(['profile', 'achievements', 'appearance', 'feed', 'guild', 'hunterPets', 'items', 'mounts', 'pets', 'petSlots', 'professions', 'progression', 'pvp', 'quests', 'reputation', 'stats', 'statistics', 'talents', 'titles', 'audit'], args.fields);
