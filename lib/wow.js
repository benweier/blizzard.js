...
WoW.prototype.achievement = function achievement (args) {
  return this.get(`/wow/achievement/${args.id}`, args);
};
...
WoW.prototype.auction = function auction (args) {
  return this.get(`/wow/auction/data/${args.realm}`, args);
};
...
WoW.prototype.character = function character (fields, args) {
  return this.get(`/wow/character/${args.realm}/${args.name}`, { fields });
};
...
WoW.prototype.mount = function mount (args) {
  return this.get('/wow/mount/', args);
};
...
WoW.prototype.pet = function pet (key, args) {
  if (key !== 'list') {
    return this.get(`/wow/pet/${key}/${args.id}`, args);
  }

  return this.get('/wow/pet/', args);
};
...
WoW.prototype.pvp = function pvp (args) {
  return this.get(`/wow/leaderboard/${args.bracket}`);
};
...
WoW.prototype.quest = function quest (args) {
  return this.get(`/wow/quest/${args.id}`);
};
...
WoW.prototype.recipe = function recipe (args) {
  return this.get(`/wow/recipe/${args.id}`);
};
...
WoW.prototype.spell = function spell (args) {
  return this.get(`/wow/spell/${args.id}`);
};
...
WoW.prototype.zone = function zone (args) {
  return this.get(`/wow/zone/${args.id}`);
};
