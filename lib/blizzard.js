 ...
 * @param  {String} [args.locale] A language code for this region
 * @param  {Object} [opts]        An instance config object compatible with [axios]{@link https://github.com/mzabriskie/axios}
 * @return {Promise}              A theneable Promises/A+ reference
 */
Blizzard.prototype.get = function get (path, args, opts) {
  const config = Object.assign({}, this.defaults, args);
  const instance = Object.assign({}, this.instance, opts);
...
Blizzard.prototype.all = function all (requests) {
  return this.instance.all(requests);
};
