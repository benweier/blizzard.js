 ...
 * @param  {Object} [instance]    An [axios](https://github.com/mzabriskie/axios) compatible instanceance configuration
...
Blizzard.prototype.get = function get (path, args, instance) {
  ...
  return this.axios.get(url, Object.assign({}, this.instance, instance));
};
