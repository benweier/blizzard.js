...
Blizzard.prototype.get = function get (path, args, instance) {
  ...
  const params = Object.assign({}, this.defaults.params, config.params, this.params(['apikey', 'access_token'], config), { locale: endpoint.locale });
  const obj = Object.assign({}, instance, this.instance, { params });
