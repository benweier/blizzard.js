 ...
 * @param  {Object} [instance]      An instance config object compatible with [axios](https://github.com/mzabriskie/axios)
 ...
 * @param  {Object} [inst]        An instance config object compatible with [axios](https://github.com/mzabriskie/axios)
...
Blizzard.prototype.get = function get (path, args, inst) {
  ...
  const url = `${endpoint.hostname}${encodeURI(path)}`;

  return this.axios.get(url, instance);
};
