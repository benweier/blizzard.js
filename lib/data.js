...
Data.prototype.connectedRealm = function connectedRealm (args, instance) {
  if (args.realm) {
    return this.blizzard.get(`/data/wow/connected-realm/${args.realm}`, args, instance);
  }
...
Data.prototype.mythicLeaderboard = function mythicLeaderboard (args, instance) {
  if (args.realm && args.dungeon && args.period) {
    return this.blizzard.get(`/data/wow/connected-realm/${args.realm}/mythic-leaderboard/${args.dungeon}/period/${args.period}`, args, instance);
  }

  return this.blizzard.get(`/data/wow/connected-realm/${args.realm}/mythic-leaderboard/`, args, instance);
};
