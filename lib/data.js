 ...
 */
Data.prototype.credentials = function credentials ({ origin, id, secret }) {
  return this.blizzard.fetchToken({ type: 'client_credentials', id, secret, origin });
};
 ...
 * @return {Promise}            A thenable Promises/A+ reference
 */
Data.prototype.validate = function validate ({ origin, token }) {
  return this.blizzard.checkToken({ origin, token });
};
