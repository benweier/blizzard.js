...
D3.prototype.era = function era (args, instance) {
  if (!args.id) {
    return this.blizzard.get('/data/d3/era/', args, instance);
  }

  if (!args.leaderboard) {
    return this.blizzard.get(`/data/d3/era/${args.id}`, args, instance);
  }

  return this.blizzard.get(`/data/d3/era/${args.id}/leaderboard/${args.leaderboard}`, args, instance);
};
...
D3.prototype.season = function profile (args, instance) {
  if (!args.season && !args.leaderboard) {
    return this.blizzard.get('/data/d3/season/', args, instance);
  }

  if (!args.leaderboard) {
    return this.blizzard.get(`/data/d3/season/${args.season}`, args, instance);
  }

  return this.blizzard.get(`/data/d3/season/${args.season}/${args.leaderboard}`, args, instance);
};
